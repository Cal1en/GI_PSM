...
namespace GenshinImpactMovementSystem
{
    public class PlayerMovementState : IState
    {
        ...
        private void Move()
        {
            ...
            float targetRotationYAngle = Rotate(movementDirection);//7/13
        ...
        protected float GetMovementSpeed(bool shouldConsiderSlopes = true)
        {
            ...
            //Debug.Log(movementData.BaseSpeed * stateMachine.ReusableData.MovementSpeedModifier * stateMachine.ReusableData.MovementOnSlopesSpeedModifier);
        ...
        protected void UpdateCameraRecenteringState(Vector2 movementInput)
        {
            ...
            float cameraVerticalAngle = stateMachine.Player.MainCameraTransform.eulerAngles.x;//eulerangles·µ»Ø0-360
            ...
            cameraVerticalAngle = MathF.Abs(cameraVerticalAngle);//ÐèÒª0-90
