...
namespace GenshinImpactMovementSystem
{
    public class PlayerGroundedState : PlayerMovementState
    {
        ...
        public override void Enter()
        {
            ...
            StartAnimation(stateMachine.Player.AnimationdData.GroundedParameterHash);
        ...
        public override void Exit()
        {
            ...
            StopAnimation(stateMachine.Player.AnimationdData.GroundedParameterHash);
        }
        ...
        private void Float()
        {
            ...
            if (Physics.Raycast(downwardsRayFromCapsuleCenter, out RaycastHit hit, slopeData.FloatRayDistance, stateMachine.Player.LayerData.GroundLayer, QueryTriggerInteraction.Ignore))
            {
                ...
                stateMachine.Player.Rigidbody.AddForce(liftForce, ForceMode.VelocityChange); //添加浮动胶囊后，刚体速度将不断在正负微分值之间交替变化
            }                                                                           //因为刚体不断受重力下落，Float又不断将其拉回
        ...
        private bool IsThereGroundUnderneath()
        {
            ...
            return overlappedGroundColliders.Length > 0; //数组中存放的是所有与OverlapBox接触的Collider
        }
        #endregion
